...
router.get("/:coin", async (req, res) => {
  ...
  try {
    ...
    const claudeResponse = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({ model: "claude-haiku-4-5-20251001", max_tokens: 300, messages: [{ role: "user", content: "Analyze crypto headlines for " + coin + ". Return ONLY JSON: {sentiment: bullish or bearish or neutral, score: 0 to 100, summary: 2 sentences}. Headlines: " + headlines }] }),
    });
...
fs.writeFileSync("routes/sentiment.js", content);
console.log("sentiment.js written!");
